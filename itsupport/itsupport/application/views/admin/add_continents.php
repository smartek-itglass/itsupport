<?php include_once 'header.php'; include_once 'menu.php'; ?>
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="row">
                <div class="col-md-12">
                    <h3 class="page-title">Continents <small> Management</small></h3>
                    <ul class="page-breadcrumb breadcrumb">
                        <li><i class="fa fa-home"></i><a href="<?php echo base_url(); ?>index.php/admin/home"> Home </a><i class="fa fa-angle-right"></i></li>
                        <li><a href="<?php echo base_url(); ?>/index.php/adminhome/addContinents">Continents  Management</a></li> 
                    </ul>
                </div>
            </div>
            <div class="row">
                            ...
                            <form id="add_continent"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                <div class="form-body">
                                    <div class="form-group"><label class="col-md-3 control-label">Continent Name</label>
                                        <div class="col-md-4">
                                            <input type="text" value="<?php if(isset($detail)){ echo $detail[0]['continent_name'];}?>" name="continent_name" id="continent_name" class="form-control"  placeholder="Continent name">		
                                            <label class="error" for="continent_name" generated="true" style="color: Red;  font-weight: normal;"></label>
                                            <span style="color:red;"><?php echo form_error('continent_name');?></span>
                                        </div>
                                    </div>
                                    <div class="form-group"><label class="col-md-3 control-label">Nombre del continente</label>
                                        <div class="col-md-4">
                                            <input type="text" value="<?php if(isset($detail)){ echo $detail[0]['continent_spanish'];}?>" name="continent_spanish" id="continent_spanish" class="form-control"  placeholder="Nombre del continente">		
                                            <label class="error" for="continent_spanish" generated="true" style="color: Red;  font-weight: normal;"></label>
            ...
            <div class="row" >
                <div class="col-md-12">
                    <div class="portlet box blue">
                        <div class="portlet-title"><div class="caption"><i class="fa fa-edit"></i>Continent List</div></div>
                                	...
                                	if(isset($data))
									{
                                        ...
                                        <tr>
                                            ...
                                            <a style="padding-left: 10px;" onclick="return confirm('Are you sure? You Want To Delete This?')" 
                                                 href="<?php echo base_url()?>index.php/adminhome/deleteContinent/<?php echo $value['continent_id'];?>">
