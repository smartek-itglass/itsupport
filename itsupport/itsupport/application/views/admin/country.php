            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="page-breadcrumb breadcrumb">
                        ...
                        <li><a href="<?php echo base_url(); ?>/index.php/adminhome/Country">Country  Management</a></li> 
                    </ul>
                </div>
            </div>
           <?php
				...
				if(!empty($data)){ 
					  foreach($data as $editVal){
						  if(isset($editVal['is_edit']) && $editVal['is_edit'] == 1){
						     ...
						     $editId = $editVal['country_id'];
							 $editName = $editVal['country_name']; 
						  }
					  }
				 }
			?>
                ...
                <div class="col-md-10 ">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body form">
                            <form id="countryAdd" action="<?php echo base_url(); ?>index.php/adminhome/Country" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                <div class="form-body">
                                    <div class="form-group"><label class="col-md-3 control-label">Country</label>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" value="<?php echo $editName; ?>" name="country_name" id="country_name" class="form-control"  placeholder="Enter Country">		
                                    ...
                                    <div class="form-actions fluid" style="margin-top:0px; padding-top:0px; padding-bottom:0px;">
                                        <div class="col-md-offset-3 " style="margin-left: 0px; padding-left: 0px; text-align: right;">
                                            ...
                                            <?php if($editId != ''){ ?>
                                            <a href="<?php echo base_url(); ?>/index.php/adminhome/Country" class="btn blue">Cancel</a>
                                            <?php } else { ?>
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                <thead>
                                    <tr> <th style="width:5%;">Sr.no</th> <th>Country </th><th style="width: 280px;">ACTION </th> </tr>		
                                </thead>
                                <tbody> 
                            	<?php
                                	if(isset($data))
									{
                                        ...
                                        <tr>
                                            ...
                                            <td><a style="padding-left: 10px;" href="<?php echo base_url()?>index.php/adminhome/editCountry/<?php echo $value['country_id'];?>">
                                               <span class="glyphicon glyphicon-edit"></span>
                                            </a>
                                            <a style="padding-left: 10px;" onclick="return confirm('Are you sure? You Want To Delete This?')" 
                                                 href="<?php echo base_url()?>index.php/adminhome/deleteCountry/<?php echo $value['country_id'];?>">
