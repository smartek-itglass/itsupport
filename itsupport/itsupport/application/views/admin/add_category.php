                            ...
                            <form id="add_category"  method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                <div class="form-body">
                                    <div class="form-group"><label class="col-md-3 control-label">Category Name</label>
                                        <div class="col-md-4">
                                            <input type="text" value="<?php if(isset($detail)){ echo $detail[0]['category_name'];}?>" name="category_name" id="category_name" class="form-control"  placeholder="category name">		
                                    ...
                                    <div class="form-group"><label class="col-md-3 control-label">nombre de la categoría</label>
                                        <div class="col-md-4">
                                            <input type="text" value="<?php if(isset($detail)){ echo $detail[0]['category_spanish'];}?>" name="category_spanish" id="category_spanish" class="form-control"  placeholder="nombre de la categoría">		
                                    ...
                                    <div class="form-group"><label class="col-md-3 control-label">Category Image</label>
                                        <div class="col-md-4">
                                        	<?php
                                        	if(isset($detail))
                                        	{
                                        		echo '<input type="file" value="" name="category_image1" id="category_image1" class="form-control"  >		
                                            <label class="error" for="category_image1" generated="true" style="color: Red;  font-weight: normal;"></label>';	
                                        	}
											else 
											{
												echo '<input type="file" value="" name="category_image" id="category_image" class="form-control"  >		
                                            <label class="error" for="category_image" generated="true" style="color: Red;  font-weight: normal;"></label>';	
											}	
                                        	?>	
                            	...
                            	<?php
                                	if(isset($data))
									{
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size: 15px;"><?php echo $value['category_spanish']; ?></td>
                                            <td style="font-size: 15px;"><img src="<?php echo $this->admin_model->get_user_img_url('category', $value['category_image'])?>" width="50" height="50"/></td>
                                            
                                            <td><a style="padding-left: 10px;" href="<?php echo base_url()?>index.php/adminhome/addCategory/<?php echo $value['category_id'];?>">
                                               <span class="glyphicon glyphicon-edit"></span>
                                            </a>
                                            <a style="padding-left: 10px;" onclick="return confirm('Are you sure? You Want To Delete This?')" 
                                                 href="<?php echo base_url()?>index.php/adminhome/deleteCategory/<?php echo $value['category_id'];?>">
