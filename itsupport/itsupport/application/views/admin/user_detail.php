<?php include_once 'header.php'; include_once 'menu.php'; ?>
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="row">
                <div class="col-md-12"><h3 class="page-title">User<small> Detail</small></h3>
                    <ul class="page-breadcrumb breadcrumb">
                        <li><i class="fa fa-home"></i><a href="<?php echo base_url(); ?>index.php/admin/home"> Home </a><i class="fa fa-angle-right"></i></li>
                        <li><a href="<?php echo base_url(); ?>index.php/adminlevelone/userList">User Management</a><i class="fa fa-angle-right"></i></li>
                        <li><a href="<?php echo base_url(); ?>index.php/adminlevelone/userList">User Detail</a></i></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            ...
                            <div class="caption" style="float: right;">
                                <a class="btn btn-default green btn-sm" href="<?php echo base_url(); ?>index.php/adminlevelone/userList">
                                <i class=""></i> View User List</a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="<?php echo base_url(); ?>index.php/adminlevelone/addUser" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                <div class="form-body">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-9" style="margin-bottom: 15px;">
                                                <input type="text" disabled value="<?php echo $mobile; ?>" class="form-control" >
                                            </div>
                                    ...
                                    <div class="form-actions fluid" style="margin-bottom:0px; padding-top:0px; padding-bottom:0px;">
                                        <div class="col-md-offset-9 " style="margin-left: 40%; padding-left: 0px; text-align: left;">
                                            <a href="<?php echo base_url(); ?>index.php/adminlevelone/userList" class="btn blue">Back</a>	
                                        </div>
                                    </div>
                                </div>        
                            </form>
